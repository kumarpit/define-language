...
;; Lam-opticon-lang v9: same as just-exprs-lang-v9 but lambdas may only
;; appear as letrec binding right-hand sides, not as anonymous trivials.
(define-language lam-opticon-lang-v9
